...
{
    public class Db_BillDetail_Channel
    {
        /// <summary>
        /// 主键
        /// </summary>
        ...
        public string RollChannel { get; set; } = "0";
        /// <summary>
        /// 交易渠道:参照代码表
        /// </summary>
        ...
        /// 退款流水号
        /// </summary>
        public string RefundChannelId { get; set; }
        /// <summary>
        /// 原渠道交易流水号
        /// </summary>
    ...
    public class Db_BillDetail_ChannelMapper : EntityTypeConfiguration<Db_BillDetail_Channel>
    {
        public Db_BillDetail_ChannelMapper()
        {
            ToTable("UT_BillDetail_Channel");
            HasKey(o => o.Id);
        }
    }
}
